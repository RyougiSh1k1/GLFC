...
def args_parser():
    ...
    parser.add_argument('--numclass', type=int, default=20, help="number of data classes in the first task")  # Changed to 20
    ...
    parser.add_argument('--task_size', type=int, default=20, help='number of data classes each task')  # Changed to 20
    parser.add_argument('--seed', type=int, default=2021, help='random seed')
    parser.add_argument('--memory_size', type=int, default=2000, help='size of exemplar memory')
    parser.add_argument('--epochs_local', type=int, default=50, help='local epochs of each global round')
    parser.add_argument('--learning_rate', type=float, default=2.0, help='learning rate')
    parser.add_argument('--num_clients', type=int, default=10, help='initial number of clients')  # Changed to 10
    parser.add_argument('--local_clients', type=int, default=5, help='number of selected clients each round')  # Changed to 5 (half of 10)
